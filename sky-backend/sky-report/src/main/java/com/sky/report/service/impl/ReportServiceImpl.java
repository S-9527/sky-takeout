...
import com.sky.report.vo.BusinessDataVO;
import com.sky.report.vo.OrderReportVO;
...
public class ReportServiceImpl implements ReportService {
    ...
    public UserReportVO getUserStatistics(LocalDate begin, LocalDate end) {
        ...
        for (LocalDate date : dateList) {
            ...
            //总用户数量
            Integer totalUser = userService.countByMap(map);

            map.put("begin", beginTime);
            //新增用户数量
            Integer newUser = userService.countByMap(map);
    ...
    public SalesTop10ReportVO getSalesTop10(LocalDate begin, LocalDate end) {
        ...
        List<GoodsSalesDTO> salesTop10 = orderService.getSalesTop10(beginTime, endTime);
